...
function renderSeriesDetail() {
    ...
    var seriesSlug = detailSlug.indexOf('series-') === 0 ? detailSlug : 'series-' + detailSlug;
    ...
    function renderSeriesQueryPagination(currentPage, totalPages) {
        ...
        function pageHref(targetPage) {
            return '/series/?series=' + encodeURIComponent(AYU_TAG_UTILS.getSeriesSlug(seriesSlug)) + '&page=' + targetPage;
        }
    ...
    var tagUrl = '/ghost/api/content/tags/?key=' + encodeURIComponent(contentKey) + '&filter=slug:' + encodeURIComponent(seriesSlug) + '&limit=1';
    var featuredUrl = '/ghost/api/content/posts/?key=' + encodeURIComponent(contentKey) + '&include=tags,authors&filter=tag:' + encodeURIComponent(seriesSlug) + '+featured:true&limit=1';
    var postsUrl = '/ghost/api/content/posts/?key=' + encodeURIComponent(contentKey) + '&include=tags,authors&filter=tag:' + encodeURIComponent(seriesSlug) + '&order=published_at%20desc&limit=' + String(AYU_GLOBALS.PAGINATION_PAGE_SIZE) + '&page=' + String(page);
    ...
    Promise.all([
        ...
        .then(function (results) {
            ...
            nameEl.textContent = AYU_TAG_UTILS.getDisplayName(tagData, seriesSlug);
            ...
            var defaults = (typeof AYU_DEFAULT_IMAGES !== 'undefined' && AYU_DEFAULT_IMAGES) ? AYU_DEFAULT_IMAGES : {};
            var headerImage = tagData.feature_image || defaults.SERIES_TAG || '/assets/images/fallback/series-tag-default.png';
            ...
            normalizePostTaxonomyTags(featuredFeed);
            normalizePostTaxonomyTags(postFeed);
